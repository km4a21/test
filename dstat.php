...
<head>
    ...
    <title>lonelogin.xyz | Layer 7 Dstat</title>
    ...
    <script language="JavaScript">
        $(function() {
            ...
            var count = 0;
            var extra = [
                'Layer7 Graph by lone - HIT >> https://lonelogin.xyz/nginx_status <<',
                'Requests Per Second of https://lonelogin.xyz/nginx_status',
                '# Requests', 
            ];
            ...
            {
                $.ajax({
                    url: "https://lonelogin.xyz/nginx_status",
                    dataType: "text",
                    cache: false
                })
                .done(function(data) {
...
<font color="white">hit https://lonelogin.xyz/</font>
